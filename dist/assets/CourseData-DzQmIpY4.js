function o(e){return d.find(i=>i.subfield===e)}function c(){return t}const t=[{key:"programming",label:"编程与算法基础",seq:1,courses:["c-lang","python","java-oop","cpp-oop","data-structure","algorithm","compiler"]},{key:"systems",label:"计算机系统",seq:2,courses:["computer-arch","os","computer-network","database"]},{key:"software",label:"软件工程",seq:3,courses:["software-eng","software-test"]},{key:"ai",label:"人工智能方向",seq:4,courses:["discrete-math","probability","ai-intro","ai-ml","ai-dl","ai-nlp","ai-cv","ai-rl"]},{key:"frontier",label:"前沿与应用",seq:5,courses:["computer-graphics","security","big-data-cloud"]}],p=[{key:"preview",label:"课前预习",icon:"BookOpen",description:"新课预热，通俗化讲解降低学习门槛",color:"#00d4ff",subModes:[{key:"concept-overview",label:"概念速览",desc:"快速了解核心概念"},{key:"case-intro",label:"案例式科普",desc:"通过案例理解抽象内容"}]},{key:"inclass",label:"课中解惑",icon:"Zap",description:"即时扫清课堂知识盲区",color:"#7c3aed",subModes:[{key:"quick-qa",label:"碎片答疑",desc:"精简回答不打断节奏"},{key:"catch-up",label:"跟不上了",desc:"重新讲解当前知识点"}]},{key:"homework",label:"课后实验",icon:"PenTool",description:"全流程实操指导，规范实验操作",color:"#06d6a0",subModes:[{key:"code-tutor",label:"代码辅导",desc:"逐行指导代码编写"},{key:"debug-help",label:"Bug 调试",desc:"定位并修复代码错误"},{key:"report-guide",label:"报告撰写",desc:"规范实验报告格式"}]},{key:"exam",label:"考前冲刺",icon:"Target",description:"聚焦高频考点，助力综合考核",color:"#f59e0b",subModes:[{key:"review-points",label:"考点梳理",desc:"梳理高频考点"},{key:"problem-types",label:"题型解析",desc:"典型题详解"},{key:"project-guide",label:"大作业指导",desc:"项目全流程指导"}]}],l={preview:[{q:"什么是机器学习？它和传统编程有什么不同？",category:"概念入门",submodes:["concept-overview"]},{q:"深度学习是怎么从神经网络发展而来的？",category:"概念入门",submodes:["concept-overview"]},{q:"大语言模型为什么能理解人类语言？",category:"科普",submodes:["case-intro"]},{q:"用一个生活例子解释什么是监督学习",category:"案例",submodes:["case-intro"]},{q:"计算机网络的 TCP/IP 协议栈是什么？",category:"概念入门",submodes:["concept-overview"]},{q:"什么是操作系统？它主要做什么？",category:"概念入门",submodes:["concept-overview"]}],inclass:[{q:"能不能再解释一下过拟合是什么意思？",category:"概念不清",submodes:["quick-qa"]},{q:"反向传播的链式法则具体是怎么计算的？",category:"算法原理",submodes:["catch-up"]},{q:"Attention 机制里的 Q、K、V 到底是什么关系？",category:"算法原理",submodes:["catch-up"]},{q:"交叉熵损失函数为什么比均方误差更适合分类？",category:"概念不清",submodes:["quick-qa"]},{q:"CNN 的卷积层和池化层各有什么作用？",category:"概念不清",submodes:["quick-qa","catch-up"]}],homework:[{q:"帮我看看这个 KNN 的代码哪里有问题",category:"代码调试",submodes:["debug-help"]},{q:"怎么用 Pandas 对缺失值进行填充？",category:"数据处理",submodes:["code-tutor"]},{q:"PyTorch 训练循环的标准写法是什么？",category:"代码辅导",submodes:["code-tutor"]},{q:"帮我写一份数据分析实验报告模板",category:"报告撰写",submodes:["report-guide"]}],exam:[{q:"机器学习面试常考算法有哪些？",category:"考点梳理",submodes:["review-points"]},{q:"偏差和方差的区别 Trade-off 怎么理解？",category:"高频考点",submodes:["review-points","problem-types"]},{q:"手撕一个决策树的伪代码",category:"题型解析",submodes:["problem-types"]},{q:"LLM 大作业从选题到实现的全流程指导",category:"大作业指导",submodes:["project-guide"]}]},n=[{id:"data-collection",name:"数据采集",description:"收集原始数据，包括结构化数据、文本、图像等",dataPreview:"原始数据集: 1000 条样本, 20 个特征"},{id:"data-cleaning",name:"数据清洗",description:"处理缺失值、异常值、重复数据",params:[{key:"missing_strategy",label:"缺失值处理",type:"select",options:["删除","均值填充","中位数填充","前向填充"],default:"均值填充"},{key:"outlier_threshold",label:"异常值阈值",type:"number",default:3}],dataPreview:"清洗后: 985 条样本, 无缺失值"},{id:"feature-engineering",name:"特征工程",description:"特征编码、标准化、降维、特征选择",params:[{key:"scale_method",label:"标准化方法",type:"select",options:["StandardScaler","MinMaxScaler","RobustScaler"],default:"StandardScaler"},{key:"dim_reduction",label:"降维方法",type:"select",options:["无","PCA","t-SNE"],default:"无"}],dataPreview:"特征矩阵: 985 × 15 维"},{id:"data-split",name:"数据集划分",description:"将数据划分为训练集、验证集和测试集",params:[{key:"train_ratio",label:"训练集比例",type:"number",default:.7},{key:"val_ratio",label:"验证集比例",type:"number",default:.15}],dataPreview:"训练集: 689 条 / 验证集: 148 条 / 测试集: 148 条"},{id:"model-training",name:"模型训练",description:"选择算法并进行模型训练与超参数调优",params:[{key:"algorithm",label:"算法选择",type:"select",options:["线性回归","决策树","随机森林","SVM","KNN"],default:"随机森林"},{key:"cv_folds",label:"交叉验证折数",type:"number",default:5}],dataPreview:"训练完成: 准确率 0.892"},{id:"model-evaluation",name:"模型评估",description:"使用测试集评估模型性能，分析误差",dataPreview:"测试集准确率: 0.875 | F1: 0.863 | AUC: 0.912"}],r=[{id:"data-prep",name:"数据准备",description:"数据加载、增强、归一化、批次生成",dataPreview:"训练集: 50000 张图片, 增强后: 200000 张"},{id:"model-design",name:"模型设计",description:"设计网络架构：卷积层、池化层、全连接层",params:[{key:"conv_layers",label:"卷积层数",type:"number",default:4},{key:"hidden_dim",label:"隐藏层维度",type:"number",default:512}],dataPreview:"参数量: 2.3M"},{id:"training-loop",name:"训练循环",description:"前向传播、损失计算、反向传播、参数更新",params:[{key:"epochs",label:"训练轮数",type:"number",default:50},{key:"batch_size",label:"批次大小",type:"number",default:32},{key:"learning_rate",label:"学习率",type:"number",default:.001}],dataPreview:"Epoch 25/50 | Loss: 0.234 | Acc: 0.912"},{id:"evaluation",name:"性能评估",description:"在测试集上评估模型泛化能力",dataPreview:"Test Acc: 0.928 | Precision: 0.931 | Recall: 0.925"},{id:"deployment",name:"模型部署",description:"导出模型、部署到生产环境、推理测试",dataPreview:"推理延迟: 23ms/样本 | 吞吐量: 43 样本/s"}],s=[{id:"text-preprocessing",name:"文本预处理",description:"分词、去停用词、词干提取/词形还原",params:[{key:"tokenizer",label:"分词器",type:"select",options:["jieba","BERT Tokenizer","spaCy"],default:"jieba"}],dataPreview:"原始: 1000 篇文档 | 分词后: 85000 个词条"},{id:"embedding",name:"词向量表示",description:"将文本转换为数值向量：Word2Vec / GloVe / BERT",dataPreview:"词向量维度: 300 | 词汇表大小: 50000"},{id:"sequence-modeling",name:"序列建模",description:"使用 RNN / LSTM / Transformer 建模序列依赖",params:[{key:"model_type",label:"模型类型",type:"select",options:["LSTM","GRU","Transformer"],default:"Transformer"}],dataPreview:"序列长度: 128 | 隐藏维度: 256"},{id:"output-generation",name:"输出生成",description:"根据任务生成：分类标签 / 翻译文本 / 摘要",dataPreview:"准确率: 0.934 | BLEU: 0.872"}],a={"model-training":[{title:"KNN 分类器从零实现",description:"从零实现 K-近邻算法并评测",language:"python",code:`import numpy as np
...
class Neuron:
    ...
    def train(self, X, y, lr=0.1, epochs=100):
        for epoch in range(epochs):
            ...
            if epoch % 20 == 0: print(f"Epoch {epoch}: Loss = {np.mean(err**2):.6f}")`}],mindMap:[{id:"mm-dl-root",label:"深度学习",children:[{id:"mm-dl-basic",label:"神经网络基础",children:[{id:"mm-dl-perc",label:"感知机"},{id:"mm-dl-bp",label:"反向传播"},{id:"mm-dl-act",label:"激活函数"}]},{id:"mm-dl-cnn",label:"CNN",children:[{id:"mm-dl-conv",label:"卷积层"},{id:"mm-dl-pool",label:"池化层"},{id:"mm-dl-fc",label:"全连接层"}]},{id:"mm-dl-rnn",label:"RNN",children:[{id:"mm-dl-lstm",label:"LSTM"},{id:"mm-dl-gru",label:"GRU"}]},{id:"mm-dl-trans",label:"Transformer",children:[{id:"mm-dl-attn",label:"自注意力"},{id:"mm-dl-mha",label:"多头注意力"},{id:"mm-dl-ffn",label:"前馈网络"}]}]}]},{id:"dl-cnn",name:"卷积神经网络",description:"卷积层、池化层、经典 CNN 架构",concepts:[{id:"dl-conv",name:"卷积运算",description:"卷积核在输入上滑动提取局部特征",difficulty:"intermediate",prerequisites:["dl-mlp"]},{id:"dl-pooling",name:"池化层",description:"下采样操作：最大池化、平均池化",difficulty:"intermediate",prerequisites:["dl-conv"]},{id:"dl-classic-cnn",name:"经典架构",description:"LeNet、AlexNet、VGG、ResNet",difficulty:"advanced",prerequisites:["dl-conv","dl-pooling"]}],resources:[{type:"doc",title:"CNN 架构演化"},{type:"code",title:"PyTorch CNN 实现"}],flowStages:r}]},{id:"ai-nlp",category:"ai",seq:19,domain:"ai",subfield:"nlp",name:"自然语言处理",description:"文本处理、词向量、序列模型、大语言模型技术",icon:"FileText",difficulty:"intermediate",prerequisites:["深度学习","Python 编程"],color:"#06d6a0",topics:[{id:"nlp-basics",name:"NLP 基础",description:"分词、词性标注、命名实体识别",concepts:[{id:"nlp-tokenization",name:"分词技术",description:"基于规则/统计/神经网络的分词方法",difficulty:"beginner",prerequisites:[]},{id:"nlp-embedding",name:"词向量",description:"Word2Vec、GloVe、FastText 分布式表示",difficulty:"intermediate",prerequisites:["nlp-tokenization"]},{id:"nlp-seq",name:"序列标注",description:"POS Tagging、NER、Chunking",difficulty:"intermediate",prerequisites:["nlp-tokenization"]}],flowStages:s,resources:[{type:"doc",title:"NLP 入门教程"},{type:"code",title:"Word2Vec 实现"}]},{id:"nlp-transformer",name:"Transformer 与预训练模型",description:"自注意力机制、BERT、GPT 系列",concepts:[{id:"nlp-attention",name:"注意力机制",description:"Query-Key-Value 注意力计算",difficulty:"advanced",prerequisites:["nlp-seq"]},{id:"nlp-bert",name:"BERT",description:"双向编码器表示，MLM+NSP 预训练",difficulty:"advanced",prerequisites:["nlp-attention"]},{id:"nlp-gpt",name:"GPT 系列",description:"自回归语言模型，Scaling Law",difficulty:"advanced",prerequisites:["nlp-attention"]}],resources:[{type:"doc",title:"Transformer 精讲"},{type:"mindmap",title:"预训练模型演进"}],codeExamples:[{title:"Scaled Dot-Product Attention",description:"实现单头自注意力计算",language:"python",code:`import torch
...
> 需要我做几道同类题目帮你巩固吗？`};export{d as a,o as b,m as c,r as d,a as e,c as g,n as m,s as n,l as p,p as s};
