  ...
  <div
    :class="[
      ...
      isDarkTheme
        ...
        : 'bg-white text-[#2c3e50] border-[#e2e8f0] dark:bg-[#0f172a] dark:text-slate-300 dark:border-slate-700'
    ]"
  ...
  >
    ...
    <div
      :class="[
        ...
        isDarkTheme ? 'bg-[#141625] border-[#1d2136]' : 'bg-white border-[#e9edf4] dark:border-slate-700'
      ]"
      id="ide-top-nav-bar"
    >
      <div class="flex items-center gap-3 select-none flex-wrap">
        <button
          ...
          :class="[
            ...
            isDarkTheme
              ? 'bg-[#1c1f32] hover:bg-[#252a42] border-[#2d3350] text-[#8c9bbb]'
        ...
        <div :class="['h-4 w-[1px] hidden sm:block', isDarkTheme ? 'bg-[#252940]' : 'bg-[#e2e8f0]']" />

        <h1 :class="['text-[15px] font-bold tracking-tight', isDarkTheme ? 'text-[#f0f6fc]' : 'text-[#1e293b]']">
          {{ activeConcept.name }}
        </h1>
      ...
      <div class="flex items-center gap-2 flex-wrap">
        <button
          ...
          :class="[
            ...
            starredConcepts[activeConcept.id]
              ...
              : isDarkTheme
                ? 'bg-transparent border-[#2d3350] hover:border-slate-500 text-slate-400 hover:text-white'
        ...
        <button
          ...
          :class="[
            ...
            isDarkTheme ? 'border-[#2d3350] hover:border-slate-500 text-slate-400 hover:text-white' : 'border-[#cbd5e1] hover:border-slate-400 text-slate-500 hover:text-[#1e293b]'
          ]"
        >
          <Share2 :size="14" />
          <span>分享</span>
    ...
    <div
      :class="[
        ...
        isDarkTheme ? 'bg-[#0f172a]' : 'bg-white dark:bg-[#0f172a]'
      ]"
      id="ide-main-canvas"
    >
      ...
      <div
        :class="[
          ...
          isDarkTheme ? 'bg-[#10121d] border-[#1a1c27]' : 'bg-[#fff] border-[#e4ebf3] dark:border-slate-700'
        ]"
        id="ide-column-sidebar-directory"
      >
        <div class="flex flex-col gap-3">
          <div class="flex flex-col gap-1.5 border-b pb-2 mb-1 border-slate-700/20 select-none">
            <span :class="['text-[12px] font-bold tracking-wider uppercase', isDarkTheme ? 'text-[#8c9ba5]' : 'text-slate-500']">当前关联课程</span>
            <div class="relative">
              <select
                ...
                :class="[
                  ...
                  isDarkTheme
                    ? 'bg-[#151724] border-[#2c334d] text-[#b4c6ef] hover:border-[#3b82f6]'
          ...
          <div class="flex items-center justify-between pb-1 text-[#8c9ba5] select-none font-mono">
            ...
            <div
              ...
              :class="[
                ...
                selectedConceptId === item.id
                  ? isDarkTheme
                    ? 'bg-[#1d2d4c] border-[#3b82f6]/50 text-[#60a5fa] font-bold shadow-sm'
                    : 'bg-[#f0f5ff] border-[#4a6cf7]/40 text-[#4a6cf7] font-bold shadow-sm'
                  : isDarkTheme
                    ? 'bg-transparent border-transparent text-[#a0a5b5] hover:bg-[#151722] hover:text-[#fff]'
            ...
            >
              <div
                ...
                :class="[
                  ...
                  isDarkTheme ? 'bg-[#3b82f6]' : 'bg-[#4a6cf7]'
                ]"
              />
              ...
              <ChevronRight
                ...
                :class="[
                  ...
                  selectedConceptId === item.id ? 'text-blue-400' : 'text-slate-400'
                ]"
              />
            </div>
          </div>
        ...
        <div class="mt-4 pt-3.5 border-t border-slate-700/30 select-none space-y-4">
          <div class="font-mono">
            <div class="flex justify-between items-center text-[13px] mb-1 font-bold">
              ...
              <span :class="isDarkTheme ? 'text-slate-200' : 'text-[#1a1a2e]'">62%</span>
            </div>

            <div :class="['h-1.5 rounded-full overflow-hidden', isDarkTheme ? 'bg-[#151926]' : 'bg-[#e2e8f0]']">
              <div class="h-full bg-[#1677ff] rounded-full" style="width: 62%" />
            </div>
          </div>
          ...
          <div
            ...
            :class="[
              ...
              isDarkTheme
                ? 'bg-[#131522] border-[#22273c] text-indigo-200 hover:border-slate-500'
      ...
      <div
        :class="[
          'lg:col-span-2 border-b lg:border-b-0 lg:border-r p-3.5 flex flex-col justify-between',
          isDarkTheme ? 'bg-[#11131c] border-[#1a1c27]' : 'bg-white border-[#e4ebf3] dark:border-slate-700'
        ]"
        id="ide-column-problem-tabs-panel"
      >
        <div class="flex items-center border-b border-slate-700/20 pb-1.5 mb-3.5 select-none font-sans font-medium text-[14.5px]">
          <button
            @click="activeTab = '题目描述'"
            :class="[
              'flex-1 text-center pb-2 relative transition-all cursor-pointer',
              activeTab === '题目描述'
                ? 'text-[#2e82ff] font-bold'
                : 'text-slate-400 hover:text-slate-200'
            ]"
          >
            题目描述
            <div v-if="activeTab === '题目描述'" class="absolute bottom-0 left-0 right-0 h-[2px] bg-[#3b82f6]" />
          </button>
          ...
          >
            提交记录
            <div v-if="activeTab === '提交记录'" class="absolute bottom-0 left-0 right-0 h-[2px] bg-[#3b82f6]" />
          </button>
          ...
          >
            讨论区
            <div v-if="activeTab === '讨论区'" class="absolute bottom-0 left-0 right-0 h-[2px] bg-[#3b82f6]" />
          </button>
        </div>

        <!-- TAB 1: 题目描述 -->
        <div v-if="activeTab === '题目描述'" class="flex-1 flex flex-col justify-between overflow-y-auto max-h-[520px] pr-1 scrollbar-thin select-text" id="problem-desc-scroller">
          <div class="space-y-4">
            <div class="space-y-2">
              <h3 :class="['text-[15.5px] font-bold', isDarkTheme ? 'text-slate-100' : 'text-slate-800']">
                题目描述
              </h3>
              <p :class="['leading-relaxed leading-6 text-[14px] whitespace-pre-line', isDarkTheme ? 'text-slate-300' : 'text-slate-600']">
            ...
            <div class="space-y-3.5">
              <div class="space-y-1.5">
                <h4 :class="['text-[14.5px] font-bold font-sans', isDarkTheme ? 'text-[#f0f3f6]' : 'text-slate-800']">输入格式</h4>
                <p :class="['text-[14px]', isDarkTheme ? 'text-slate-400' : 'text-slate-600']">
                  {{ activeConcept.inputFormat }}
                </p>
              </div>

              <div class="space-y-1.5">
                <h4 :class="['text-[14.5px] font-bold font-sans', isDarkTheme ? 'text-[#f0f3f6]' : 'text-slate-800']">输出格式</h4>
                <p :class="['text-[14px]', isDarkTheme ? 'text-slate-400' : 'text-slate-600']">
            ...
            <div class="space-y-4 pt-1">
              <div v-for="(sample, sIdx) in activeConcept.samples" :key="sIdx" class="space-y-2">
                <h4 :class="['text-[14.5px] font-bold', isDarkTheme ? 'text-slate-100' : 'text-slate-800']">
                  示例 {{ sIdx + 1 }}
                </h4>

                <div class="space-y-2">
                  <div class="space-y-1">
                    <span class="text-[13px] text-[#8c9ba5] block font-mono">输入</span>
                    <div :class="['p-2.5 rounded-lg border font-mono text-[13.5px] leading-relaxed', isDarkTheme ? 'bg-[#0a0c12] border-[#222736]' : 'bg-[#f8fafc] border-[#cbd5e1]']">
                      {{ sample.input }}
                    </div>
                  </div>

                  <div class="space-y-1">
                    <span class="text-[13px] text-[#8c9ba5] block font-mono">输出</span>
                    <div :class="['p-2.5 rounded-lg border font-mono text-[13.5px] leading-relaxed', isDarkTheme ? 'bg-[#0a0c12] border-[#222736]' : 'bg-[#f8fafc] border-[#cbd5e1]']">
                      {{ sample.output }}
                    </div>
                  </div>
        ...
        <div v-if="activeTab === '提交记录'" class="flex-grow overflow-y-auto max-h-[500px] space-y-3 pr-1" id="sub-history-area">
          <div class="flex justify-between items-center text-[13px] text-slate-400 pb-1.5 border-b border-slate-700/20">
            <span>提交时间</span>
            <span>测评状态</span>
          </div>
          ...
          <template v-if="(submissionHistory[activeConcept.id] || []).length > 0">
            <div
              ...
              :key="hIdx"
              :class="['p-2.5 rounded-lg border transition-all', isDarkTheme ? 'bg-[#151722]/60 border-[#222638]' : 'bg-slate-50 border-slate-100']"
            >
              ...
              <div class="flex justify-between text-[12px] text-slate-400 font-mono">
          ...
          <div v-else class="text-center py-12 text-slate-500 font-mono">
            [ 针对该专项，暂无提交历史记录 ]
          </div>
        </div>
        ...
        <div v-if="activeTab === '讨论区'" class="flex-grow flex flex-col justify-between overflow-hidden h-[480px]">
          <div class="flex-1 overflow-y-auto space-y-3.5 pr-1 max-h-[350px]">
            <template v-if="(conceptQuestions[activeConcept.id] || []).length > 0">
              <div
                ...
                :key="qIdx"
                :class="['p-2.5 rounded-lg border leading-relaxed', isDarkTheme ? 'bg-[#131522] border-[#202538]' : 'bg-slate-50 border-slate-100']"
              >
                <div class="flex justify-between text-[12.5px] mb-1.5 select-none text-slate-400 font-mono">
                  <span class="font-bold text-blue-400">{{ qa.user }}</span>
                  <span>{{ qa.time }}</span>
                </div>
                <p :class="['text-[13.5px] leading-relaxed select-text', isDarkTheme ? 'text-slate-200' : 'text-slate-700']">
                  {{ qa.content }}
                </p>
          ...
          <form @submit="handlePostQuestion" class="border-t border-slate-700/20 pt-2.5 mt-2 space-y-2">
            <input
              type="text"
              placeholder="写下疑问或思考..."
              ...
              :class="[
                ...
                isDarkTheme
                  ? 'bg-[#090a10] border-[#222538] text-white focus:border-blue-500'
      ...
      <div
        :class="[
          'lg:col-span-5 border-b lg:border-b-0 lg:border-r flex flex-col justify-between',
          isDarkTheme ? 'bg-[#12131f] border-[#1a1c27]' : 'bg-[#fcfdfe] border-[#e4ebf3] dark:border-slate-700'
        ]"
      ...
      >
        <div
          :class="[
            ...
            isDarkTheme ? 'bg-[#131522] border-[#22253c]' : 'bg-[#f1f4f8] border-[#cbd5e1]'
          ]"
          id="editor-heading-row"
        >
          <span :class="['font-bold font-sans', isDarkTheme ? 'text-slate-200' : 'text-slate-800']">
            代码编辑器
          </span>
          ...
          <div class="flex items-center gap-1 font-mono">
            <select
              ...
              :class="[
                ...
                isDarkTheme
                  ? 'bg-[#090a10] border-[#252a3f] text-[#3b82f6]'
        ...
        <div class="flex-1 flex align-stretch font-mono relative text-[14px] bg-[#07080e]" id="editor-body-zone">
          <div class="w-9 bg-[#0b0c13] border-r border-[#151928] text-[#555e75] text-right pr-2 py-4 select-none leading-6 text-[14px]">
        ...
        <div
          :class="[
            ...
            isDarkTheme ? 'bg-[#131522] border-[#22253c]' : 'bg-[#f8fafc] border-[#cbd5e1]'
          ]"
        ...
        >
          <button
            ...
            :class="[
              ...
              isDarkTheme
                ? 'bg-[#1b1c2b] border-[#2d324d] hover:border-slate-500 text-slate-300'
          ...
          <button
            ...
            class="px-5 py-1.5 text-[13.5px] font-bold tracking-wider rounded-lg flex items-center gap-1.5 bg-[#1677ff] hover:bg-[#4096ff] text-white border-none cursor-pointer transition-all disabled:opacity-50"
          >
      ...
      <div
        :class="[
          'lg:col-span-3 p-4 flex flex-col justify-between',
          isDarkTheme ? 'bg-[#121421]' : 'bg-white'
        ]"
        id="ide-column-run-results-panel"
      >
        <div class="flex flex-col gap-3">
          <div class="flex items-center justify-between pb-1 border-b border-slate-700/20 text-slate-400 select-none font-sans font-medium">
            <span>运行结果</span>
          </div>
          ...
          <div class="space-y-1">
            ...
            <p class="text-[13px] text-slate-400 font-mono select-none">
          ...
          <div class="space-y-2 max-h-[400px] overflow-y-auto pr-0.5 select-none" id="test-case-suite">
            <span class="text-[13px] text-slate-400 font-mono block mb-1">测试用例</span>
            ...
            <div
              ...
              :class="[
                ...
                isDarkTheme ? 'bg-[#171a29]/90 border-[#2d324d]' : 'bg-[#f7fafe] border-[#cbd5e1]'
              ]"
            >
              ...
              <div class="grid grid-cols-12 gap-1.5 font-mono text-[12.5px]">
                <div class="col-span-12 flex items-center justify-between gap-2">
                  ...
                  <span :class="['px-2 py-0.5 leading-none rounded select-all', isDarkTheme ? 'bg-[#0a0c12] text-slate-300' : 'bg-white text-slate-700']">{{ tc.input || '(空)' }}</span>
                </div>

                <div class="col-span-12 flex items-center justify-between gap-2 bg-[#10ffff]/5 p-1 rounded">
                  <span class="text-slate-400">预期</span>
                  <span class="text-[#a5b4fc] font-bold">{{ tc.expected }}</span>
                </div>
        ...
        <div class="flex gap-2 border-t border-slate-700/20 pt-4 mt-auto select-none" id="ide-right-action-row">
          <button
          ...
          <button
            ...
            :class="[
              ...
              isDarkTheme
                ? 'bg-[#1b1d28] border-[#22273d] hover:border-slate-500 text-slate-300'
                : 'bg-white border-slate-300 hover:bg-slate-50 text-slate-700'
            ]"
          >
            查看题解
    ...
    <Transition name="toast-slide">
      <div
        v-if="showToast"
        class="fixed bottom-6 right-6 px-4 py-3 bg-[#1d2745] hover:bg-[#23315a] border border-[#3b82f6]/60 text-[#a5fcb8] font-mono text-[13.5px] rounded-lg shadow-2xl flex items-center gap-2 select-none z-50"
      >
